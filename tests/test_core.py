...
from pytest_readable.i18n import detect_language_from_text, get_i18n, resolve_language
...
def test_markdown_export_localizes_title_and_labels():
    ...
    assert "**Que prueba:** Retorna documentos ordenados" in markdown
...
def test_csv_export_localizes_headers():
    ...
    assert csv_content.startswith("Archivo,Clase,Test,Que prueba,Pasos,Estado,NodeID")
