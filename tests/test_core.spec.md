...
**Pasos:**
1. Construye una suite en memoria con un caso documentado
2. Ejecuta `render_markdown` con idioma espanol
...
**Pasos:**
1. Construye una suite en memoria
2. Ejecuta `render_csv` con idioma espanol
...
**Pasos:**
1. Define `PYTEST_READABLE_LANG` con valor espanol
...
**Pasos:**
1. Limpia `PYTEST_READABLE_LANG`, `LC_ALL` y `LANG`
